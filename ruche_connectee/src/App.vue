...
import CapteurComponent from './components/CapteurComponent.vue';
import CapteurGPSComponent from './components/CapteurGPSComponent.vue';
...
<template>
  ...
  <CapteurComposent></CapteurComposent>
